    ...
    <div>
        <el-card class="box-card el-card__body" shadow="hover">
            ...
            <div class="fileInfo"><!--info-->
                <span>上传者：<el-link type="info" :underline="false">{{resource.account}}</el-link></span>
                <span>上传时间：<el-link type="info" :underline="false">{{timestamp13ToTime(resource.releaseTime)}}</el-link></span>
                <span>所需硬币：<el-link type="danger" :underline="false" icon="el-icon-s-goods">5</el-link></span>
                <el-button  type="primary" size="medium" class="fileButton" @click="gotoResource(resource.rid)">查看详情</el-button>
            </div>
        </el-card>
    </div>
</template>
